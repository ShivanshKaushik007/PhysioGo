        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/FindAPhysio" className="text-gray-600 hover:text-blue-600 transition-colors">
                  Find a Physio
                </Link>
              </li>
              <li>
                <Link href="/AiMatcher" className="text-gray-600 hover:text-blue-600 transition-colors">
                  AI Matcher
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="https://twitter.com/physiogo"
                target="_blank"
              ...
              <a
                href="https://facebook.com/physiogo"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 hover:text-blue-600 transition-colors"
              >
              ...
              <a
                href="https://linkedin.com/company/physiogo"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 hover:text-blue-600 transition-colors"
              >
              ...
              <a
                href="https://instagram.com/physiogo"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 hover:text-blue-600 transition-colors"
              >
